...
from evidently.tests import TestNumberOfMissingValues, TestTargetFeaturesCorrelations, TestShareOfDriftedColumns
...
async def get_report():
    ...
    data_test = TestSuite(
        tests=[TestNumberOfMissingValues(), TestTargetFeaturesCorrelations(), TestShareOfDriftedColumns()]
    )
